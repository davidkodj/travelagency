  ...
  const bgLayout = (
    <div className="absolute inset-0 pointer-events-none">
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse, rgba(196,163,90,0.15) 0%, transparent 70%)",
        }}
      />
      <div
      ...
      >
        <div className="text-center mb-10">
          ...
          >
            ...
            <span className="font-display font-bold text-2xl text-ivory">
        ...
        <div className="bg-raised border border-subtle rounded-2xl p-8 shadow-2xl shadow-abyss/80">
          <h1 className="font-display font-bold text-2xl text-ivory mb-1">
            {t("title")}
          </h1>
          ...
          >
            {[
              ...
              <div key={name} className="space-y-2">
                ...
                <Input
                  id={name}
                  {...register(name as keyof F)}
                  type={type}
                  autoComplete={auto}
                  placeholder={ph}
                />
                {errors[name as keyof F] && (
                  <p className="text-red-400 text-xs">
                    {errors[name as keyof F]?.message}
                  </p>
                )}
              </div>
            ))}
