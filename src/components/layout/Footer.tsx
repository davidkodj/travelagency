    ...
    <footer className="bg-abyss border-t border-subtle">
      <div className="container max-w-6xl px-6 mx-auto pt-16 pb-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-14">
          ...
          <div>
            <h5 className="text-copper text-xs font-bold tracking-[0.15em] uppercase mb-5">
              {t("services")}
            </h5>
            <ul className="flex flex-col gap-3 text-sm text-ivory-muted">
              {["Voyages organisés", "Sur mesure", "Visa & démarches"].map(
                (s) => (
                  <li key={s}>
                    <Link
                      href={`/${locale}/voyages`}
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3 text-sm text-ivory-muted">
              ...
              <li className="flex items-center gap-2">
                <MapPin className="w-4 h-4" /> Bruxelles, Belgique
              </li>
            </ul>
          </div>
        </div>
