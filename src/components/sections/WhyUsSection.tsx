...
const reviews = [
  { stars: 5, text: '"Mon visa Schengen obtenu en 10 jours. Itinéraire parfait, je recommande à 100%."', author: 'Aminata K.', city: 'Lomé, Togo' },
  { stars: 5, text: '"Voyage en famille à Paris, tout était parfait. Suivi WhatsApp très réactif."', author: 'Kofi M.', city: 'Lomé, Togo' },
]
  ...
  return (
    <section id="why" className="py-28 bg-surface relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-[0.015]"
        style={{ backgroundImage: 'repeating-linear-gradient(45deg, #C4A35A 0, #C4A35A 1px, transparent 0, transparent 50%)', backgroundSize: '24px 24px' }} />
      ...
      <div className="container max-w-6xl px-6 mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
          ...
          >
            ...
            <p className="text-ivory-muted text-lg leading-relaxed mb-12">{t('subtitle')}</p>
              ...
              {features.map((f, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      <h4 className="font-semibold text-ivory mb-1.5">{f.title}</h4>
          ...
          >
            ...
            <div className="flex items-center gap-5 bg-copper/5 border border-copper/20 rounded-2xl p-6">
              <div className="font-display font-black text-6xl gradient-text leading-none">4.9</div>
              ...
              <div>
                ...
                <p className="text-ivory-muted text-sm leading-relaxed">{t('ratingLabel')}</p>
              </div>
            </div>
            ...
            {reviews.map((r, i) => (
              ...
              >
                ...
                <p className="text-sm text-ivory/80 leading-[1.75] italic mb-4">{r.text}</p>
                <p className="text-xs text-ivory-muted font-medium">{r.author} <span className="text-ivory-muted/50">— {r.city}</span></p>
              </motion.div>
            ))}
          </motion.div>
        </div>
